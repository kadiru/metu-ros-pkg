#ifndef PCL16_TRACKING_IMPL_PARTICLE_OMP_FILTER_H_
#define PCL16_TRACKING_IMPL_PARTICLE_OMP_FILTER_H_

template <typename PointInT, typename StateT> void
pcl16::tracking::ParticleFilterOMPTracker<PointInT, StateT>::weight ()
{
  if (!use_normal_)
  {
...
#define PCL16_INSTANTIATE_ParticleFilterOMPTracker(T,ST) template class PCL16_EXPORTS pcl16::tracking::ParticleFilterOMPTracker<T,ST>;
