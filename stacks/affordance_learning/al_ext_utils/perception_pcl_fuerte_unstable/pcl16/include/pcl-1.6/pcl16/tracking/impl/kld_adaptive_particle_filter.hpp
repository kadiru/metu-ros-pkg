#ifndef PCL16_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_FILTER_H_
#define PCL16_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_FILTER_H_

template <typename PointInT, typename StateT> bool
pcl16::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::initCompute ()
{
...
template <typename PointInT, typename StateT> bool
pcl16::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::insertIntoBins
...
pcl16::tracking::KLDAdaptiveParticleFilterTracker<PointInT, StateT>::resample ()
{
  unsigned int k = 0;
  unsigned int n = 0;
...
#define PCL16_INSTANTIATE_KLDAdaptiveParticleFilterTracker(T,ST) template class PCL16_EXPORTS pcl16::tracking::KLDAdaptiveParticleFilterTracker<T,ST>;
