#ifndef PCL16_TRACKING_PARTICLE_FILTER_H_
#define PCL16_TRACKING_PARTICLE_FILTER_H_

#include <pcl16/tracking/tracking.h>
#include <pcl16/tracking/tracker.h>
#include <pcl16/tracking/coherence.h>
#include <pcl16/filters/passthrough.h>
#include <pcl16/octree/octree.h>
  ...
  namespace tracking
  {
    ...
    class ParticleFilterTracker: public Tracker<PointInT, StateT>
    {
      ...
      protected:
        ...
        pcl16::PassThrough<PointInT> pass_x_;
        /** \brief pass through filter to crop the pointclouds within the hypothesis bounding box*/
        pcl16::PassThrough<PointInT> pass_y_;
        /** \brief pass through filter to crop the pointclouds within the hypothesis bounding box*/
        pcl16::PassThrough<PointInT> pass_z_;
        ...
        boost::shared_ptr<pcl16::octree::OctreePointCloudChangeDetector<PointInT> > change_detector_;
...
// #include <pcl16/tracking/impl/particle_filter.hpp>

#endif //PCL16_TRACKING_PARTICLE_FILTER_H_
