"""autogenerated by genpy from al_srvs/GetSceneRequest.msg. Do not edit."""
import sys
...
class GetSceneRequest(genpy.Message):
  _md5sum = "681be043f4885d2f1db598bf03cf4ca8"
  _type = "al_srvs/GetSceneRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetSceneRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_f.pack(self.seconds_ago))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.seconds_ago,) = _struct_f.unpack(str[start:end])
      return self
...
"""autogenerated by genpy from al_srvs/GetSceneResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetSceneResponse(genpy.Message):
  _md5sum = "58db3fb1283b21fa11ce072303128236"
  _type = "al_srvs/GetSceneResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """al_msgs/Scene scene
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetSceneResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.scene is None:
        self.scene = al_msgs.msg.Scene()
    else:
      self.scene = al_msgs.msg.Scene()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.scene.entities.header.seq, _x.scene.entities.header.stamp.secs, _x.scene.entities.header.stamp.nsecs))
      _x = self.scene.entities.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.scene.entities.entities)
      buff.write(_struct_I.pack(length))
      for val1 in self.scene.entities.entities:
        ...
        for val3 in _v10.features:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.scene.human_partner_exists))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.scene.entities.header.seq, _x.scene.entities.header.stamp.secs, _x.scene.entities.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.scene.entities.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.scene.entities.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.scene.entities.entities.append(val1)
      start = end
      end += 1
      (self.scene.human_partner_exists,) = _struct_B.unpack(str[start:end])
      self.scene.human_partner_exists = bool(self.scene.human_partner_exists)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class GetScene(object):
  _type          = 'al_srvs/GetScene'
  _md5sum = '3b2abdb69359bad7a80a3e6eabf2698b'
  _request_class  = GetSceneRequest
  _response_class = GetSceneResponse
