"""autogenerated by genpy from al_msgs/Entity.msg. Do not edit."""
import sys
...
class Entity(genpy.Message):
  _md5sum = "3aededd89fd07bd4fed617a782094dfa"
  _type = "al_msgs/Entity"
...
"""
  __slots__ = ['collision_object','cloud_object','feature_vector']
  _slot_types = ['arm_navigation_msgs/CollisionObject','sensor_msgs/PointCloud2','al_msgs/FeatureVector']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       collision_object,cloud_object,feature_vector
    ...
    if args or kwds:
      ...
      if self.cloud_object is None:
        self.cloud_object = sensor_msgs.msg.PointCloud2()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3I.pack(_x.cloud_object.header.seq, _x.cloud_object.header.stamp.secs, _x.cloud_object.header.stamp.nsecs))
      _x = self.cloud_object.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I.pack(_x.cloud_object.height, _x.cloud_object.width))
      length = len(self.cloud_object.fields)
      buff.write(_struct_I.pack(length))
      for val1 in self.cloud_object.fields:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      _x = self
      buff.write(_struct_B2I.pack(_x.cloud_object.is_bigendian, _x.cloud_object.point_step, _x.cloud_object.row_step))
      _x = self.cloud_object.data
      length = len(_x)
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.cloud_object.is_dense))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cloud_object.header.seq, _x.cloud_object.header.stamp.secs, _x.cloud_object.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.cloud_object.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.cloud_object.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.cloud_object.height, _x.cloud_object.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.cloud_object.fields = []
      for i in range(0, length):
        ...
        self.cloud_object.fields.append(val1)
      _x = self
      start = end
      end += 9
      (_x.cloud_object.is_bigendian, _x.cloud_object.point_step, _x.cloud_object.row_step,) = _struct_B2I.unpack(str[start:end])
      self.cloud_object.is_bigendian = bool(self.cloud_object.is_bigendian)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.cloud_object.data = str[start:end].decode('utf-8')
      else:
        self.cloud_object.data = str[start:end]
      start = end
      end += 1
      (self.cloud_object.is_dense,) = _struct_B.unpack(str[start:end])
      self.cloud_object.is_dense = bool(self.cloud_object.is_dense)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
