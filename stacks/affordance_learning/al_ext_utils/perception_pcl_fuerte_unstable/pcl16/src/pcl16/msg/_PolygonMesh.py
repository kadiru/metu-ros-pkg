"""autogenerated by genpy from pcl16/PolygonMesh.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/PointCloud2','pcl16/Vertices[]']
