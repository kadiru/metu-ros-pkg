...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    get_filename_component(FLANN_ROOT "/home/kadir/workspace/Dropbox/metu-ros-pkg/trunk/affordance_learning/al_ext_utils/perception_pcl_fuerte_unstable/flann/include" PATH)
  endif(PCL_ALL_IN_ONE_INSTALLER)
  if(PKG_CONFIG_FOUND)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/home/kadir/workspace/Dropbox/metu-ros-pkg/trunk/affordance_learning/al_ext_utils/perception_pcl_fuerte_unstable/pcl16/build/pcl_trunk")
...
set(pcl_all_components  common octree io kdtree search sample_consensus filters geometry segmentation visualization features surface registration keypoints tracking )
...
list (APPEND PCL_DEFINITIONS " -march=native")
