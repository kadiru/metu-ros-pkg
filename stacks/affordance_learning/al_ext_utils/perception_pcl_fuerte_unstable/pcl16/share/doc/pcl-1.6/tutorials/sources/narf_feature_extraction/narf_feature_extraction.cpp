...
#include <pcl16/features/narf_descriptor.h>
...
main (int argc, char** argv)
{
  ...
  pcl16::NarfDescriptor narf_descriptor (&range_image, &keypoint_indices2);
  narf_descriptor.getParameters ().support_size = support_size;
  narf_descriptor.getParameters ().rotation_invariant = rotation_invariant;
  pcl16::PointCloud<pcl16::Narf36> narf_descriptors;
