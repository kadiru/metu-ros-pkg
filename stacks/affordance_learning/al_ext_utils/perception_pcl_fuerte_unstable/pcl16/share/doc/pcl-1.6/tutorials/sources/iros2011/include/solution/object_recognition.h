...
class ObjectRecognition
{
    ...
    populateDatabase (const std::vector<std::string> & filenames)
    {
      ...
      for (size_t i = 0; i < n; ++i)
      {
        ...
        if (filename.compare (filename.size ()-4, 4, ".pcd") == 0)
        {
          ...
          pcl16::io::loadPCDFile (filenames[i], *raw_input);
      ...
      kdtree_ = pcl16::KdTreeFLANN<GlobalDescriptorT>::Ptr (new pcl16::KdTreeFLANN<GlobalDescriptorT>);
  ...
  protected: 
    ...
    applyFiltersAndSegment (const PointCloudPtr & input, const ObjectRecognitionParameters & params) const
    {
      ...
      pcl16::copyPointCloud (*cloud, cluster_indices[0], *largest_cluster);
                      ...
                      const ObjectRecognitionParameters & params) const
    {
      ...
      pcl16::transformPointCloud (*(source.points), *output, tform);
    ...
    pcl16::KdTreeFLANN<GlobalDescriptorT>::Ptr kdtree_;
};
