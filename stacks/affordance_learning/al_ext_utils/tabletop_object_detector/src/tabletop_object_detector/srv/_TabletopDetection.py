"""autogenerated by genpy from tabletop_object_detector/TabletopDetectionRequest.msg. Do not edit."""
import sys
...
class TabletopDetectionRequest(genpy.Message):
  _md5sum = "f42d30308c026708dba683b43ccd22b8"
...
"""
  __slots__ = ['return_clusters','return_models','num_models']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       return_clusters,return_models,num_models
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2Bi.pack(_x.return_clusters, _x.return_models, _x.num_models))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.return_clusters, _x.return_models, _x.num_models,) = _struct_2Bi.unpack(str[start:end])
...
"""autogenerated by genpy from tabletop_object_detector/TabletopDetectionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TabletopDetectionResponse(genpy.Message):
  _md5sum = "1887016fd77eb33b9e6335b14d02b156"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_7d4fb.pack(_x.detection.table.pose.pose.position.x, _x.detection.table.pose.pose.position.y, _x.detection.table.pose.pose.position.z, _x.detection.table.pose.pose.orientation.x, _x.detection.table.pose.pose.orientation.y, _x.detection.table.pose.pose.orientation.z, _x.detection.table.pose.pose.orientation.w, _x.detection.table.x_min, _x.detection.table.x_max, _x.detection.table.y_min, _x.detection.table.y_max, _x.detection.table.convex_hull.type))
      length = len(self.detection.table.convex_hull.dimensions)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.detection.table.convex_hull.dimensions))
      length = len(self.detection.table.convex_hull.triangles)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.detection.table.convex_hull.triangles))
      length = len(self.detection.table.convex_hull.vertices)
      buff.write(_struct_I.pack(length))
      for val1 in self.detection.table.convex_hull.vertices:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.detection.table.pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.detection.table.convex_hull.dimensions = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.detection.table.convex_hull.triangles = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.detection.table.convex_hull.vertices.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.detection.table.convex_hull.dimensions.tostring())
      length = len(self.detection.table.convex_hull.triangles)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.detection.table.convex_hull.triangles.tostring())
      length = len(self.detection.table.convex_hull.vertices)
      buff.write(_struct_I.pack(length))
      for val1 in self.detection.table.convex_hull.vertices:
        _x = val1
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.detection.table.convex_hull.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.detection.table.convex_hull.triangles = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.detection.table.convex_hull.vertices = []
...
class TabletopDetection(object):
  _type          = 'tabletop_object_detector/TabletopDetection'
  _md5sum = '2c2af970832ab0ca635bc95df7de690a'
