...
{
  pcl16::SampleConsensusInitialAlignment<PointT, PointT, LocalDescriptorT> sac_ia;
                 ...
                 float outlier_rejection_threshold, float transformation_epsilon, float max_iterations)
{
  ...
  pcl16::IterativeClosestPoint<PointT, PointT> icp;
  ...
  pcl16::transformPointCloud (*source_points, *source_points_transformed, initial_alignment);
