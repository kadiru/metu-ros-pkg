#ifndef PCL16_TRACKING_COHERENCE_H_
#define PCL16_TRACKING_COHERENCE_H_
...
namespace pcl16
{
  ...
  namespace tracking
  {
    ...
    public:
      ...
      /** \brief get a list of pcl16::tracking::PointCoherence.*/
      inline std::vector<PointCoherencePtr>
      getPointCoherences () { return point_coherences_; }

      /** \brief set a list of pcl16::tracking::PointCoherence.
        * \param coherences a list of pcl16::tracking::PointCoherence.
        */
      inline void
...
#include <pcl16/tracking/impl/coherence.hpp>
