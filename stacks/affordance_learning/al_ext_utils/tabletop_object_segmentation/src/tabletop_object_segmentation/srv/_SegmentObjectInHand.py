"""autogenerated by genpy from tabletop_object_segmentation/SegmentObjectInHandRequest.msg. Do not edit."""
import sys
...
class SegmentObjectInHandRequest(genpy.Message):
  _md5sum = "5653c37b6f08aa700c4b89db4ec53db6"
  _type = "tabletop_object_segmentation/SegmentObjectInHandRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SegmentObjectInHandRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.wrist_frame is None:
        self.wrist_frame = ''
    else:
      self.wrist_frame = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.wrist_frame = str[start:end].decode('utf-8')
      else:
        self.wrist_frame = str[start:end]
      return self
...
"""autogenerated by genpy from tabletop_object_segmentation/SegmentObjectInHandResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SegmentObjectInHandResponse(genpy.Message):
  _md5sum = "9503d54a94abc90c0593a7f7530fb70e"
  _type = "tabletop_object_segmentation/SegmentObjectInHandResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  __slots__ = ['cluster','result']
  _slot_types = ['sensor_msgs/PointCloud2','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SegmentObjectInHandResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_Bi.pack(_x.cluster.is_dense, _x.result))
    except struct.error as se: self._check_types(se)
    except TypeError as te: self._check_types(te)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cluster.is_dense, _x.result,) = _struct_Bi.unpack(str[start:end])
...
class SegmentObjectInHand(object):
  _type          = 'tabletop_object_segmentation/SegmentObjectInHand'
  _md5sum = '3ce40b2b26a5a7d08d4f8e1e350c63f7'
  _request_class  = SegmentObjectInHandRequest
  _response_class = SegmentObjectInHandResponse
