"""autogenerated by genpy from al_msgs/CloudObjects.msg. Do not edit."""
import sys
...
class CloudObjects(genpy.Message):
  _md5sum = "abd8bc4a7ed0075ad47205d5b1ec762a"
  _type = "al_msgs/CloudObjects"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """sensor_msgs/PointCloud2[] cloud_objects
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CloudObjects, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.cloud_objects is None:
        self.cloud_objects = []
    else:
      self.cloud_objects = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.cloud_objects)
      buff.write(_struct_I.pack(length))
      for val1 in self.cloud_objects:
        _v1 = val1.header
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.cloud_objects.append(val1)
      return self
