...
{
  pcl16::NormalEstimation<PointT, NormalT> normal_estimation;
  normal_estimation.setSearchMethod (pcl16::search::KdTree<PointT>::Ptr (new pcl16::search::KdTree<PointT>));
...
{
  pcl16::SIFTKeypoint<PointT, pcl16::PointWithScale> sift_detect;
  sift_detect.setSearchMethod (pcl16::search::KdTree<PointT>::Ptr (new pcl16::search::KdTree<PointT>));
  sift_detect.setScales (min_scale, nr_octaves, nr_scales_per_octave);
  sift_detect.setMinimumContrast (min_contrast);
  sift_detect.setInputCloud (points);
  pcl16::PointCloud<pcl16::PointWithScale> keypoints_temp;
  sift_detect.compute (keypoints_temp);
  PointCloudPtr keypoints (new PointCloud);
  pcl16::copyPointCloud (keypoints_temp, *keypoints);
...
{
  pcl16::FPFHEstimation<PointT, NormalT, LocalDescriptorT> fpfh_estimation;
  fpfh_estimation.setSearchMethod (pcl16::search::KdTree<PointT>::Ptr (new pcl16::search::KdTree<PointT>));
...
{
  pcl16::VFHEstimation<PointT, NormalT, GlobalDescriptorT> vfh_estimation;
  vfh_estimation.setSearchMethod (pcl16::search::KdTree<PointT>::Ptr (new pcl16::search::KdTree<PointT>));
