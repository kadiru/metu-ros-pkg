#ifndef PCL16_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_OMP_FILTER_H_
#define PCL16_TRACKING_IMPL_KLD_ADAPTIVE_PARTICLE_OMP_FILTER_H_

template <typename PointInT, typename StateT> void
pcl16::tracking::KLDAdaptiveParticleFilterOMPTracker<PointInT, StateT>::weight ()
{
  if (!use_normal_)
  {
...
#define PCL16_INSTANTIATE_KLDAdaptiveParticleFilterOMPTracker(T,ST) template class PCL16_EXPORTS pcl16::tracking::KLDAdaptiveParticleFilterOMPTracker<T,ST>;
