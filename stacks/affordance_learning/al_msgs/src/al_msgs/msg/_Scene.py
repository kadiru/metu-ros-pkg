"""autogenerated by genpy from al_msgs/Scene.msg. Do not edit."""
import sys
...
class Scene(genpy.Message):
  _md5sum = "5626ba3b4ed9f6b10275d25b4698aa30"
  _type = "al_msgs/Scene"
...
"""
  __slots__ = ['entities','human_partner_exists']
  _slot_types = ['al_msgs/Entities','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.human_partner_exists is None:
        self.human_partner_exists = False
    else:
      self.entities = al_msgs.msg.Entities()
      self.human_partner_exists = False
      ...
      for val1 in self.entities.entities:
        ...
        for val3 in _v10.features:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.human_partner_exists))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.human_partner_exists,) = _struct_B.unpack(str[start:end])
      self.human_partner_exists = bool(self.human_partner_exists)
      return self
