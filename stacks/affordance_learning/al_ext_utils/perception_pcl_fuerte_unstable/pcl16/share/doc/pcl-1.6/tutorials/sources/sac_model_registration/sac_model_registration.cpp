         ...
         const double thresh)
{
  ...
  {
    PCL16_ERROR ("Could not compute a valid transformation!\n");
    return;
  }
...
main (int argc, char** argv)
{
  ...
  {
    PCL16_ERROR ("Needs a source.PCD, and an output source_transformed.PCD file! For example: %s bun0.pcd bun0-tr.pcd\n", argv[0]);
    PCL16_INFO ("Additionally, please specify a threshold (0.002 used by default) via: -thresh X\n");
    return (-1);
  }
