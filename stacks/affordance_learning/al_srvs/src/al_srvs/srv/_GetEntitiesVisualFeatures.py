"""autogenerated by genpy from al_srvs/GetEntitiesVisualFeaturesRequest.msg. Do not edit."""
import sys
...
class GetEntitiesVisualFeaturesRequest(genpy.Message):
  _md5sum = "f2d5ea6f1a4b33c3865cf203aa487653"
  _type = "al_srvs/GetEntitiesVisualFeaturesRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """al_msgs/Entities entities
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetEntitiesVisualFeaturesRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.entities is None:
        self.entities = al_msgs.msg.Entities()
    else:
      self.entities = al_msgs.msg.Entities()
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.entities.header.seq, _x.entities.header.stamp.secs, _x.entities.header.stamp.nsecs))
      _x = self.entities.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.entities.entities)
      buff.write(_struct_I.pack(length))
      for val1 in self.entities.entities:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.entities.header.seq, _x.entities.header.stamp.secs, _x.entities.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.entities.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.entities.header.frame_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        self.entities.entities.append(val1)
      return self
...
"""autogenerated by genpy from al_srvs/GetEntitiesVisualFeaturesResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetEntitiesVisualFeaturesResponse(genpy.Message):
  _md5sum = "bc1eb2b3615faabf61b3ddaa90024491"
  _type = "al_srvs/GetEntitiesVisualFeaturesResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """al_msgs/FeatureVector[] feature_vectors
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetEntitiesVisualFeaturesResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.feature_vectors)
      buff.write(_struct_I.pack(length))
      for val1 in self.feature_vectors:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.feature_vectors.append(val1)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
_struct_5f = struct.Struct("<5f")
_struct_2I = struct.Struct("<2I")
class GetEntitiesVisualFeatures(object):
  _type          = 'al_srvs/GetEntitiesVisualFeatures'
  _md5sum = 'da6269e04dd35a4194501d4a83290c9a'
  _request_class  = GetEntitiesVisualFeaturesRequest
  _response_class = GetEntitiesVisualFeaturesResponse
