/* Auto-generated by genmsg_cpp for file /home/kadir/workspace/work/Dropbox/metu-ros-pkg/trunk/affordance_learning/al_msgs/msg/Entities.msg */
#ifndef AL_MSGS_MESSAGE_ENTITIES_H
#define AL_MSGS_MESSAGE_ENTITIES_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Entities_ {
  ...
  typedef std::vector< ::al_msgs::Entity_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::al_msgs::Entity_<ContainerAllocator> >::other >  _entities_type;
  std::vector< ::al_msgs::Entity_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::al_msgs::Entity_<ContainerAllocator> >::other >  entities;


  typedef boost::shared_ptr< ::al_msgs::Entities_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::al_msgs::Entities_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct Entities
typedef  ::al_msgs::Entities_<std::allocator<void> > Entities;

typedef boost::shared_ptr< ::al_msgs::Entities> EntitiesPtr;
typedef boost::shared_ptr< ::al_msgs::Entities const> EntitiesConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::al_msgs::Entities_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::al_msgs::Entities_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::al_msgs::Entities_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::al_msgs::Entities_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::al_msgs::Entities_<ContainerAllocator> > {
  static const char* value() 
  {
    return "85dd43f20f56dcd78caf1db583535320";
  }

  static const char* value(const  ::al_msgs::Entities_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x85dd43f20f56dcd7ULL;
  static const uint64_t static_value2 = 0x8caf1db583535320ULL;
};

template<class ContainerAllocator>
struct DataType< ::al_msgs::Entities_<ContainerAllocator> > {
  static const char* value() 
  {
    return "al_msgs/Entities";
  }
...
template<class ContainerAllocator>
struct Definition< ::al_msgs::Entities_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::al_msgs::Entities_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::al_msgs::Entities_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::al_msgs::Entities_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::al_msgs::Entities_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::al_msgs::Entities_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
    ...
    for (size_t i = 0; i < v.entities.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::al_msgs::Entity_<ContainerAllocator> >::stream(s, indent + "    ", v.entities[i]);
    }
  }
};
...
#endif // AL_MSGS_MESSAGE_ENTITIES_H
