...
pcl16::PolynomialCalculationsT<real>::PolynomialCalculationsT ()
{
}
...
template <typename real>
inline void 
  pcl16::PolynomialCalculationsT<real>::Parameters::setZeroValue (real new_zero_value)
{
...
template <typename real>
inline void
  pcl16::PolynomialCalculationsT<real>::solveLinearEquation (real a, real b, std::vector<real>& roots) const
{
...
template <typename real>
inline void
  pcl16::PolynomialCalculationsT<real>::solveQuadraticEquation (real a, real b, real c, std::vector<real>& roots) const
{
...
template<typename real>
inline void
  pcl16::PolynomialCalculationsT<real>::solveCubicEquation (real a, real b, real c, real d, std::vector<real>& roots) const
{
...
template<typename real>
inline void
  pcl16::PolynomialCalculationsT<real>::solveQuarticEquation (real a, real b, real c, real d, real e,
...
template<typename real>
inline pcl16::BivariatePolynomialT<real>
  pcl16::PolynomialCalculationsT<real>::bivariatePolynomialApproximation (
      std::vector<Eigen::Matrix<real, 3, 1> >& samplePoints, unsigned int polynomial_degree, bool& error) const
{
  pcl16::BivariatePolynomialT<real> ret;
...
inline bool
  pcl16::PolynomialCalculationsT<real>::bivariatePolynomialApproximation (
      ...
      pcl16::BivariatePolynomialT<real>& ret) const
{
