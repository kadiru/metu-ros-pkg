"""autogenerated by genpy from tabletop_object_detector/TabletopObjectRecognitionRequest.msg. Do not edit."""
import sys
...
class TabletopObjectRecognitionRequest(genpy.Message):
  _md5sum = "197bf138763e73e721e55b16fedc33a9"
  _type = "tabletop_object_detector/TabletopObjectRecognitionRequest"
...
"""
  __slots__ = ['table','clusters','num_models','perform_fit_merge']
  _slot_types = ['tabletop_object_detector/Table','sensor_msgs/PointCloud[]','int32','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       table,clusters,num_models,perform_fit_merge
    ...
    """
    if args or kwds:
      super(TabletopObjectRecognitionRequest, self).__init__(*args, **kwds)
      ...
      if self.num_models is None:
        self.num_models = 0
      if self.perform_fit_merge is None:
        self.perform_fit_merge = False
    else:
      self.table = tabletop_object_detector.msg.Table()
      self.clusters = []
      self.num_models = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_iB.pack(_x.num_models, _x.perform_fit_merge))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.num_models, _x.perform_fit_merge,) = _struct_iB.unpack(str[start:end])
      self.perform_fit_merge = bool(self.perform_fit_merge)
      return self
...
"""autogenerated by genpy from tabletop_object_detector/TabletopObjectRecognitionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TabletopObjectRecognitionResponse(genpy.Message):
  _md5sum = "f63a7c7df1c6f8db6a82e83c1186e00e"
  _type = "tabletop_object_detector/TabletopObjectRecognitionResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
"""
  ...
  _slot_types = ['household_objects_database_msgs/DatabaseModelPoseList[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TabletopObjectRecognitionResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
_struct_2I = struct.Struct("<2I")
_struct_3d = struct.Struct("<3d")
class TabletopObjectRecognition(object):
  _type          = 'tabletop_object_detector/TabletopObjectRecognition'
  _md5sum = 'f5867bc89b17633ae48681b939f1fbf7'
  _request_class  = TabletopObjectRecognitionRequest
  _response_class = TabletopObjectRecognitionResponse
