"""autogenerated by genpy from al_srvs/GetLearnedEffectsRequest.msg. Do not edit."""
import sys
...
class GetLearnedEffectsRequest(genpy.Message):
  _md5sum = "0cc5bcd43f45918576a2d2a8d0b0ee7a"
  _type = "al_srvs/GetLearnedEffectsRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetLearnedEffectsRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from al_srvs/GetLearnedEffectsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetLearnedEffectsResponse(genpy.Message):
  _md5sum = "43f2805f2df3b63a8abeeaca3b7f2cfc"
  _type = "al_srvs/GetLearnedEffectsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetLearnedEffectsResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class GetLearnedEffects(object):
  _type          = 'al_srvs/GetLearnedEffects'
  _md5sum = 'a57c4aa327bc0ceec7201dde9d5ec500'
  _request_class  = GetLearnedEffectsRequest
  _response_class = GetLearnedEffectsResponse
