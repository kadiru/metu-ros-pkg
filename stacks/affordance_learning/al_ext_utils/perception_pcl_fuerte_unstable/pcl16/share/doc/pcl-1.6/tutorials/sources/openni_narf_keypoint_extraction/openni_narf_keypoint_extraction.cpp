...
#include <pcl16/range_image/range_image_planar.h>
...
boost::mutex depth_image_mutex,
             ir_image_mutex,
             image_mutex;
pcl16::PointCloud<pcl16::PointXYZ>::ConstPtr point_cloud_ptr;
...
int main (int argc, char** argv)
{
  ...
  if (pcl16::console::parse (argc, argv, "-d", device_id) >= 0)
  ...
  if (pcl16::console::parse (argc, argv, "-i", min_interest_value) >= 0)
    cout << "Setting minimum interest value to "<<min_interest_value<<".\n";
  if (pcl16::console::parse (argc, argv, "-t", max_no_of_threads) >= 0)
  ...
  pcl16::Grabber* interface = new pcl16::OpenNIGrabber (device_id);
  ...
  boost::shared_ptr<pcl16::RangeImagePlanar> range_image_planar_ptr (new pcl16::RangeImagePlanar);
  pcl16::RangeImagePlanar& range_image_planar = *range_image_planar_ptr;
  
  pcl16::RangeImageBorderExtractor range_image_border_extractor;
  pcl16::NarfKeypoint narf_keypoint_detector;
  ...
  pcl16::PointCloud<pcl16::PointXYZ>::Ptr keypoints_cloud_ptr (new pcl16::PointCloud<pcl16::PointXYZ>);
  pcl16::PointCloud<pcl16::PointXYZ>& keypoints_cloud = *keypoints_cloud_ptr;
  ...
  while (!viewer.wasStopped ())
  {
    ...
    double keypoint_extraction_start_time = pcl16::getTime();
    narf_keypoint_detector.compute (keypoint_indices);
    double keypoint_extraction_time = pcl16::getTime()-keypoint_extraction_start_time;
    ...
    //for (size_t i=0; i<keypoint_indices.points.size (); ++i)
      //range_image_widget.markPoint (keypoint_indices.points[i]%range_image_planar.width,
                                    ...
                                    //pcl16::visualization::Vector3ub (0,255,0));
    
    // -------------------------------------
    // -----Show keypoints in 3D viewer-----
    // -------------------------------------
    pcl16::visualization::PointCloudColorHandlerCustom<pcl16::PointWithRange> color_handler_cloud
      (range_image_planar_ptr, 0, 0, 0);
    if (!viewer.updatePointCloud<pcl16::PointWithRange> (range_image_planar_ptr, color_handler_cloud, "range image"))
      viewer.addPointCloud<pcl16::PointWithRange> (range_image_planar_ptr, color_handler_cloud, "range image");
    ...
    pcl16::visualization::PointCloudColorHandlerCustom<pcl16::PointXYZ> color_handler_keypoints
